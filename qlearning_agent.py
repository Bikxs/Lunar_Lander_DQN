...
class QLearningAgent(object):
    def __init__(self, episodes=20000, alpha=0.1, gamma=0.90, epsilon=1.0, epsilon_decay=.99):
        ...
        # print('q table size:', len(self.states) * len(self.actions))

    def train(self):
        """Create the Q table"""
        # populating Q-table - i.e learning
        ...
        for episode in tqdm(range(self.episodes)):
            if episode % 500 == 0:
                ...
                while not done:
                    ...
                    if iterations >= MAX_ITERATIONS:
                        break
                # print('Episode {},Iterations:{} Score:{}'.format('**', iterations, round(score, 1)))
            ...
            while not done:
                ...
                self.Q[state, action] = self.Q[state, action] + \
                    ...
                    state_next, self._max_action(state_next)] - self.Q[
                                                          state, action])
